...
WITH mapping(personality_code, category_code, fit_weight, sort_order) AS (
  VALUES
    ...
    ('execution', 'R600005', 80, 6),
    ('execution', 'R600011', 80, 7),
    ('execution', 'R600016', 80, 8),
    ('execution', 'R600018', 90, 9),
    ('execution', 'R600019', 90, 10),
    ('execution', 'R600021', 90, 11),
    ('execution', 'R600022', 90, 12),
    ('execution', 'R600010', 85, 13),
    ('execution', 'R600001', 70, 14),
    ('execution', 'R600006', 70, 15),
    ('execution', 'R600012', 75, 16),
    ('execution', 'R600017', 70, 17),
    ('execution', 'R600023', 75, 18),
