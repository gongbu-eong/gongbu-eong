...
const RESULT_COPIES: Record<DiagnosisTypeCode, ResultCopy> = {
  stability: {
    ...
    strengths: [
      "정해진 일정과 루틴을 꾸준히 유지하는 힘이 있습니다. 단기간에 크게 치고 나가는 방식보다, 매일 해야 할 일을 놓치지 않고 쌓아 올리는 쪽에서 강점이 드러납니다. 장기 프로젝트나 자격증 준비처럼 중간에 흐름이 끊기기 쉬운 상황에서도 비교적 안정적으로 페이스를 지켜냅니다.\n\n조직 안에서는 이런 꾸준함이 결과의 예측 가능성을 높여줍니다. 주변에서는 쉽게 흔들리지 않고 맡은 일을 이어가는 사람으로 기억하기 쉽습니다.",

      "이미 효과가 확인된 방법을 꾸준히 적용하면서 실수와 변수를 줄이는 데 강합니다. 반복되는 업무라도 대충 넘기지 않고 필요한 절차를 차례대로 확인하는 편입니다.\n\n처음에는 속도가 조금 느려 보여도, 시간이 지날수록 결과의 편차가 줄어드는 장점이 있습니다. 특히 누락이 반복되기 쉬운 업무에서 안정감을 줍니다.\n\n한 번 크게 돋보이는 성과보다 맡은 일이 계속 안정적으로 굴러가게 만드는 쪽에 강점이 있습니다.",

      "마감과 약속, 정해진 기준을 중요하게 생각합니다. 맡은 일을 중간에 쉽게 놓지 않고 책임 범위 안에서 끝까지 마무리하려는 성향이 강합니다.\n\n어려운 상황이 생겨도 먼저 포기하기보다 일정과 기준을 다시 확인하며 끝낼 수 있는 방법을 찾습니다. 일정 준수와 지속적인 관리가 중요한 조직에서는 이런 태도가 높은 신뢰로 이어집니다. 주변에서 믿고 일을 맡기기 좋은 사람으로 평가받기 쉽습니다.",
    ],

    growthPoint:
      "검증된 방법을 선호하는 성향이 강하면 새로운 방식이 필요한 상황에서도 기존 방법을 오래 유지하려 할 수 있습니다. 변화가 필요하다는 신호를 늦게 받아들이면 대응 시점이 뒤로 밀릴 수 있습니다. 이때는 전체 방식을 한꺼번에 바꾸기보다 위험이 작은 범위에서 새 방법을 먼저 시험해보는 것이 좋습니다.\n\n작게 시도해보고 괜찮았던 방법을 자신의 기준에 추가해보세요. 안정성을 잃지 않으면서도 변화 대응력을 키울 수 있습니다.",
  },
  ...
  teamwork: {
    ...
    strengths: [
      "서로 다른 의견이 나왔을 때 한쪽의 주장만 밀어붙이기보다 각자의 입장을 듣고 공통된 방향을 찾는 데 강합니다. 의견 차이를 불편한 상황으로만 보지 않고 정리해야 할 정보로 받아들이는 편입니다.\n\n구성원이 어떤 역할을 맡으면 좋은지 살피고 업무를 자연스럽게 연결하는 능력도 발휘할 수 있습니다. 여러 사람이 함께 움직여야 하는 프로젝트에서 이런 조율 능력은 팀 전체의 안정성을 높여줍니다. 관계를 해치지 않으면서도 일을 앞으로 보내는 힘이 있습니다.",

      "혼자 판단한 결과만 고집하기보다 다른 사람의 피드백을 받아 결과물을 개선하는 방식이 잘 맞습니다. 자신의 생각과 다른 의견이 들어와도 방어적으로 반응하기보다 활용할 부분을 찾으려 합니다. 스터디, 리뷰, 회의처럼 서로 진행 상황을 점검하는 환경에서 새로운 아이디어나 부족한 부분을 빠르게 발견합니다.\n\n협업을 통해 더 완성도 높은 결과를 만들어낼 가능성이 높습니다.",

      "팀 안에서 정보가 끊기거나 역할이 연결되지 않는 부분을 비교적 빨리 발견합니다. 필요한 내용을 공유하고 구성원 간의 상황을 확인하면서 공동 목표에서 벗어나지 않도록 흐름을 맞추는 편입니다.\n\n혼자 성과를 내는 것보다 함께 움직일 수 있는 구조를 만드는 데 관심이 많습니다.\n\n부서 간 협업이나 여러 이해관계자가 함께 참여하는 업무에서는 이런 연결 능력이 특히 유용하게 쓰일 수 있습니다.",
    ],

    growthPoint:
      "주변 의견을 충분히 듣고 조율하려는 성향이 강하면 결론을 내려야 하는 시점에서도 협의가 길어질 수 있습니다. 모두의 입장을 고려하다가 본인의 판단이 늦게 드러나는 경우도 생길 수 있습니다. 모든 사람이 완전히 동의할 때까지 기다리기보다 결정해야 할 시간과 본인이 책임져야 할 범위를 먼저 정해두는 것이 좋습니다.\n\n의견을 모은 뒤 기준에 따라 결론을 내리는 연습이 더해지면 협업 능력에 주도성까지 붙습니다.",
  },
  ...
  individual: {
    ...
    strengths: [
      "혼자 충분히 집중할 수 있는 시간이 주어지면 업무의 흐름을 스스로 정리하고 안정적으로 처리하는 데 강합니다. 다른 사람의 지속적인 지시가 없어도 목표를 이해하면 필요한 작업을 찾아 진행하는 편입니다.\n\n방해가 적을수록 생각을 깊게 이어가고, 중간에 흐트러진 부분도 스스로 다시 잡아냅니다. 개인의 책임 범위가 명확하거나 높은 몰입이 필요한 업무에서 특히 좋은 성과를 낼 가능성이 있습니다.",

      "주변 사람의 의견이나 분위기에 쉽게 흔들리기보다 자신이 세운 기준을 바탕으로 판단하고 끝까지 밀고 가는 힘이 있습니다. 여러 말이 섞여 있을 때도 먼저 문제의 구조를 보고 판단하려 합니다.\n\n어려운 문제가 생겼을 때도 누군가 해결해주기를 기다리기보다 자료와 방법을 직접 찾아보려 합니다.\n\n독립적인 판단과 자기주도적인 업무 수행이 필요한 환경에서 이런 특성이 장점으로 이어집니다.",

      "하나의 문제를 깊게 살펴보고 세부적인 원인이나 구조를 파악하는 데 강합니다. 겉으로 보이는 현상만 보고 끝내기보다 왜 그런 결과가 나왔는지 확인하려는 편입니다. 여러 업무를 짧게 반복하기보다 하나의 주제를 충분히 탐색하고 분석하면서 완성도를 높이는 방식이 잘 맞을 수 있습니다.\n\n연구, 분석, 개발, 전문 업무처럼 깊은 사고와 집중이 필요한 분야에서 이러한 몰입력이 경쟁력이 됩니다.",
    ],

    growthPoint:
      "스스로 판단하고 몰입하는 능력이 강한 만큼 자신의 관점 안에서 문제를 해결하려는 경향이 커질 수 있습니다. 혼자 오래 고민하다 보면 다른 사람이 쉽게 볼 수 있는 단서를 놓칠 때도 있습니다.\n\n중요한 결정이나 여러 사람에게 영향을 주는 업무에서는 중간 단계에서 다른 사람의 의견을 짧게라도 확인해보세요.\n\n독립적인 사고는 유지하면서 외부 피드백을 보완 자료로 활용하면 좋습니다. 놓치고 있던 관점을 발견하고 결과의 완성도를 높이기 쉽습니다.",
  },
  ...
  execution: {
    ...
    strengths: [
      "해야 할 일이 보이면 오랫동안 고민하는 것보다 먼저 행동하면서 해결 방법을 찾는 힘이 있습니다. 처음부터 완벽한 방법을 찾지 못해도 가능한 부분부터 시작하는 편입니다. 실제로 움직이면서 필요한 정보와 부족한 조건을 확인하고, 그 결과를 다음 행동에 바로 반영합니다.\n\n빠른 착수가 중요한 업무나 제한된 시간 안에 결과를 만들어야 하는 상황에서 강점이 크게 나타납니다.",

      "해야 할 일을 뒤로 미루기보다 바로 행동으로 옮기는 성향이 강해 업무가 정체되는 것을 줄일 수 있습니다. 작은 업무라도 시작점을 빠르게 만드는 데 익숙합니다.\n\n시작점이 생기면 이후 필요한 사람이나 정보를 자연스럽게 연결하면서 진행 속도를 높입니다. 계획만 반복되고 실제 실행으로 이어지지 않는 상황에서 분위기를 행동 중심으로 전환시키는 역할을 할 수 있습니다.",

      "실행 과정에서 예상하지 못한 문제가 생겨도 계획이 틀어졌다는 이유로 멈추기보다 현재 상황에 맞게 행동을 조정합니다. 문제를 발견하면 오래 붙잡고 있기보다 먼저 처리 가능한 부분을 찾습니다.\n\n현장에서 얻은 정보와 반응을 활용해 다음 행동을 빠르게 결정하는 편입니다.\n\n고객 대응이나 운영처럼 즉각적인 판단이 필요한 업무에서 강점을 보일 수 있습니다.",
    ],

    growthPoint:
      "빠른 실행력은 분명한 장점이지만 속도를 우선하다 보면 처음에는 보이지 않았던 조건이나 작은 오류를 놓칠 가능성이 있습니다. 시작은 빠른데 마무리 검토가 부족하면 결과의 신뢰도가 낮아질 수 있습니다.\n\n업무를 시작하기 전에 반드시 확인할 항목을 몇 가지로 줄여 간단한 체크리스트를 만들어보세요. 시작 속도를 크게 늦추지 않는 선에서 핵심 조건을 확인하고 완료 후 한 번 더 점검하면 실행력과 완성도를 함께 높일 수 있습니다.",
  },
  ...
  planning: {
    ...
    strengths: [
      "업무를 시작하기 전에 목표와 필요한 단계를 정리해 전체 흐름을 파악하는 데 강합니다. 해야 할 일을 우선순위에 따라 나누고 일정이나 순서를 미리 결정하는 편입니다.\n\n무엇부터 처리해야 하는지 기준을 세워두기 때문에 불필요하게 반복되는 작업을 줄일 수 있습니다.\n\n여러 단계가 연결된 프로젝트에서는 이런 정리력이 진행 방향을 안정적으로 잡아주는 역할을 합니다.",

      "하나의 선택지만 바로 결정하기보다 여러 자료와 조건을 비교하면서 가능성이 높은 방법을 찾는 편입니다. 장점과 위험 요소를 함께 살펴보는 데 익숙합니다. 제한된 자원 안에서 어떤 선택이 가장 효율적인지 판단하려는 성향이 있습니다.\n\n중요한 의사결정이나 여러 대안을 비교해야 하는 업무에서 이러한 분석적인 접근이 강점으로 작용합니다.",

      "복잡하게 섞여 있는 정보에서도 중요한 기준을 찾아 분류하고 이해하기 쉬운 구조로 바꾸는 데 강합니다. 막연한 문제를 그대로 두지 않고 나눠서 보려는 편입니다.\n\n문제를 단계별로 나누고 각각 필요한 행동을 정리하기 때문에 실제로 실행할 수 있는 계획으로 전환할 수 있습니다. 기획, 분석, 프로젝트 관리처럼 많은 정보를 다뤄야 하는 업무에서 유용한 강점입니다.",
    ],

    growthPoint:
      "더 좋은 방법을 찾기 위해 충분히 분석하려는 성향이 강하면 실제 행동을 시작하는 시점이 늦어질 수 있습니다. 정보를 더 모으면 더 나은 판단을 할 수 있다는 생각 때문에 실행 기준이 흐려질 때가 있습니다. 모든 정보를 확인한 뒤 움직이기보다 현재 가진 정보로 결정해야 하는 마감 시점을 먼저 정해두는 것이 좋습니다.\n\n분석 단계와 실행 단계를 나누고 정해진 시간이 되면 작은 행동부터 시작해보세요. 기획력과 실행력을 균형 있게 활용하는 데 도움이 됩니다.",
  },
  ...
  principle: {
    ...
    strengths: [
      "업무의 세부 조건과 누락된 부분을 꼼꼼하게 확인해 문제가 커지기 전에 발견하는 데 강합니다. 작은 오류라도 결과에 영향을 줄 수 있다고 판단하면 다시 한번 확인하는 편입니다.\n\n필요한 경우 수정 근거까지 남겨두려 하기 때문에 나중에 같은 문제가 반복될 가능성도 줄어듭니다. 계약, 데이터, 문서, 비용처럼 작은 실수가 큰 영향을 줄 수 있는 업무에서 리스크를 줄이는 역할을 할 수 있습니다.",

      "정해진 기준과 절차를 일관되게 적용해 결과의 정확성과 신뢰도를 유지하는 데 강점이 있습니다. 상황마다 처리 방식이 달라지는 것보다 일정한 기준으로 업무를 관리하려 합니다.\n\n이런 성향은 결과의 편차를 줄이고, 다른 사람이 보아도 납득 가능한 처리 흐름을 만드는 데 도움이 됩니다.\n\n품질 관리나 운영 관리처럼 동일한 수준을 꾸준히 유지해야 하는 업무에서 신뢰할 수 있는 성과를 만들어낼 가능성이 높습니다.",

      "숫자와 문서, 절차처럼 세부적인 내용을 정확하게 확인해야 하는 업무에서 집중력이 잘 발휘됩니다. 필요한 정보를 하나씩 대조하면서 빠진 항목이나 서로 맞지 않는 내용을 발견하는 데 비교적 강한 편입니다. 단순히 성격이 세심한 것에 그치지 않고, 실제 업무 결과의 신뢰도를 높이는 방향으로 꼼꼼함이 쓰입니다.\n\n회계·행정·품질·데이터 관리처럼 정확성이 결과에 직접 영향을 주는 환경에서 실질적인 장점이 됩니다.",
    ],

    growthPoint:
      "정해진 원칙을 중요하게 생각하는 만큼 예상하지 못한 예외 상황에서는 판단에 시간이 걸리거나 기존 절차를 지나치게 고수할 수 있습니다. 기준을 지키려는 태도가 강할수록 예외를 다루는 방식이 더 중요해집니다.\n\n반드시 지켜야 하는 핵심 기준과 상황에 따라 조정할 수 있는 기준을 미리 구분해두는 연습이 필요합니다.\n\n원칙을 포기하라는 뜻은 아닙니다. 원칙의 목적을 지키면서 선택할 수 있는 대안을 함께 준비하면 정확성과 유연성을 동시에 높일 수 있습니다.",
  },
  ...
  flexibility: {
    ...
    strengths: [
      "처음 예상했던 상황과 다르게 일이 진행되어도 당황해서 멈추기보다 현재 사용할 수 있는 방법을 빠르게 찾는 편입니다. 기존 계획이 어려워지면 목표를 포기하기보다 다른 방법으로 결과를 만들 수 있는지를 먼저 살펴봅니다.\n\n상황이 바뀌었다는 사실보다 지금 가능한 선택지가 무엇인지에 더 빨리 집중합니다.\n\n갑작스러운 일정 변경이나 새로운 요구사항이 자주 발생하는 환경에서 이러한 대응력이 강점으로 작용합니다.",

      "기존 방식이 현재 상황에 맞지 않는다고 판단하면 방법을 그대로 고집하기보다 현실적인 조건에 맞춰 조정할 수 있습니다. 사람, 시간, 비용, 자원처럼 현재 사용할 수 있는 조건을 먼저 봅니다. 완벽한 조건을 기다리기보다 지금 실현 가능한 방법을 선택하려는 성향이 있습니다.\n\n정해진 답이 없는 문제나 제한된 자원 안에서 대안을 만들어야 하는 상황에 잘 맞습니다.",

      "새로운 사람이나 환경, 업무 방식에 비교적 빠르게 적응하면서 필요한 행동 방식을 바꾸는 데 강합니다. 낯선 상황에서도 오래 굳어 있기보다 먼저 분위기와 조건을 파악하려 합니다.\n\n변화 자체에 오래 머무르기보다 현재 상황에서 무엇을 할 수 있는지를 먼저 살피기 때문에 업무 흐름이 끊기는 것을 줄일 수 있습니다. 고객 대응이나 운영처럼 변수가 많은 업무에서 적응력과 대응력이 효과적으로 발휘됩니다.",
    ],

    growthPoint:
      "상황에 맞춰 빠르게 방법을 바꾸는 것은 장점이지만 변화가 반복되면 주변에서는 기준이 자주 달라진다고 느낄 수도 있습니다. 유연함이 방향 없음으로 보이지 않게 중심 기준을 잡아두는 것이 중요합니다. 방법은 유연하게 바꾸더라도 품질, 일정, 목표처럼 반드시 지켜야 할 핵심 기준을 2~3개 정도 정해두세요.\n\n변하지 않는 기준을 중심에 두고 실행 방법만 조정하면 유연성을 유지하면서도 결과의 일관성과 신뢰도를 높일 수 있습니다.",
  },
};
